...
@TeleOp(name = "MRI_Color_Sensor1", group = "A")
// @Autonomous(...) is the other common choice
//@Disabled
public class MRI_Color_Sensor1 extends OpMode {
    ...
    public void init() {
        ...
        sensor_color = hardwareMap.i2cDevice.get("sensor_color");
        //colorSensor = hardwareMap.colorSensor.get("sensor_color");

        colorCreader = new I2cDeviceSynchImpl(sensor_color, I2cAddr.create8bit(0x3c), false);
        colorCreader.engage();
    ...
    public void loop() {
        ...
        telemetry.addData("2 #C", ccode & 0xFF);
    }
